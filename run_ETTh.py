...
### -------  dataset settings --------------
parser.add_argument('--data', type=str, required=False, default='ETTh1', choices=['ETTh1', 'ETTh2', 'ETTm1'],
...
if args.evaluate:
    ...
    if args.itr:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_lr{}_bs{}_hid{}_s{}_l{}_dp{}_inv{}_att{}_itr{}'.format(args.model,
                                                                                                        args.data,
                                                                                                        args.features,
                                                                                                        args.seq_len,
                                                                                                        args.label_len,
        ...
        setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_lr{}_bs{}_hid{}_s{}_l{}_dp{}_inv{}_att{}_itr0'.format(args.model,
                                                                                                   args.data,
                                                                                                   args.features,
                                                                                                   args.seq_len,
                                                                                                   args.label_len,
